...
OE_USER="odoo"
OE_HOME="/$OE_USER"
OE_HOME_EXT="/$OE_USER/${OE_USER}-server0"
#The default port where this Odoo instance will run under (provided you use the command -c in the terminal)
#Set to true if you want to install it, false if you don't need it or have it already installed.
INSTALL_WKHTMLTOPDF="True"
#Set the default Odoo port (you still have to use -c /etc/odoo-server0.conf for example to use this.)
OE_PORT="8066"
...
sudo su root -c "echo 'sudo -u $OE_USER $OE_HOME_EXT/openerp-server0 --config=/etc/${OE_CONFIG}.conf' >> $OE_HOME_EXT/start.sh"
...
USER=$OE_USER
# Specify an alternate config file (Default: /etc/openerp-server0.conf).
