...
OE_USER="odoo"
OE_HOME="/$OE_USER"
OE_HOME_EXT="/$OE_USER/${OE_USER}-server10"
...
sudo su root -c "echo 'sudo -u $OE_USER $OE_HOME_EXT/openerp-server10 --config=/etc/${OE_CONFIG}.conf' >> $OE_HOME_EXT/start.sh"
