...
sudo su root -c "echo 'sudo -u $OE_USER $OE_HOME_EXT/openerp-server2 --config=/etc/${OE_CONFIG}.conf' >> $OE_HOME_EXT/start.sh"
...
USER=$OE_USER
# Specify an alternate config file (Default: /etc/openerp-server2.conf).
