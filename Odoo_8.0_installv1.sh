...
sudo su root -c "echo 'xmlrpc_port = 8068' >> /etc/$OE_CONFIG.conf"
...
sudo su root -c "echo 'xmlrpcs_port = 8078' >> /etc/$OE_CONFIG.conf"
...
echo "Once you've rebooted you'll be able to access your Odoo instance by going to http://[your server's IP address]:8068"
echo "For example, if your server's IP address is 192.168.1.123 you'll be able to access it on http://192.168.1.123:8068"